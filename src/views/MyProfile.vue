  ...
  <div class="MyProfile">
    <div class="profile_form">
      ...
      >
        <div class="form_left">
          ...
          <el-form-item class="input_form" prop="gender">
            ...
            <el-select :disabled="profile_readonly" class="input_item" v-model="basic_information.gender" placeholder="male">
              <el-option v-for="item in profile_gender" :key="item.value" :label="item.label" :value="item.value"></el-option>
            </el-select>
          </el-form-item>
        ...
        <div class="edit-btn">
          <el-button @click="edit_profile()" :class="{ active: isActive }" type="primary">confirm</el-button>
        </div>
      </el-form>
      ...
      >
        <div class="form_left">
          <el-form-item class="input_form" prop="ethnicity">
            ...
            <el-input :readonly="looks_readonly" class="input_item" placeholder="null" v-model="looks.ethnicity">
            </el-input>
          </el-form-item>
          <el-form-item class="input_form" prop="height">
            <div class="input_title">Height</div>
            <el-input :readonly="looks_readonly" class="input_item" placeholder="null" v-model="looks.height">
            </el-input>
          </el-form-item>
          <el-form-item class="input_form" prop="hair_color">
            <div class="input_title">Hair color</div>
            <el-input :readonly="looks_readonly" class="input_item" placeholder="null" v-model="looks.hair_color">
            </el-input>
          </el-form-item>
        </div>
        <div class="form_right">
          <el-form-item class="input_form" prop="body_type">
            ...
            <el-input :readonly="looks_readonly" class="input_item" placeholder="null" v-model="looks.body_type">
            </el-input>
          </el-form-item>
          <el-form-item class="input_form" prop="weight">
            <div class="input_title">Weight</div>
            <el-input :readonly="looks_readonly" class="input_item" placeholder="null" v-model="looks.weight">
            </el-input>
          </el-form-item>
          <el-form-item class="input_form" prop="eye_color">
            <div class="input_title">Eye Color</div>
            <el-input :readonly="looks_readonly" class="input_item" placeholder="null" v-model="looks.eye_color">
            </el-input>
          </el-form-item>
        </div>
        <div class="edit-btn">
          <el-button @click="edit_looks()" :class="{ active: isActive }" type="primary">confirm</el-button>
        </div>
      </el-form>
    </div>
      ...
      >
        <div class="form_left">
          <el-form-item class="input_form" prop="vaccination">
            ...
            <el-input :readonly="looks_readonly" class="input_item" placeholder="null" v-model="covid.vaccination">
            </el-input>
          </el-form-item>
        </div>
        <div class="form_right">
          <el-form-item class="input_form" prop="other">
            ...
            <el-input :readonly="looks_readonly" class="input_item" placeholder="null" v-model="covid.other">
            </el-input>
          </el-form-item>
        </div>
        <div class="edit-btn">
...
export default {
  ...
  created() {
    ...
    get_basic_information(tmp_id).then((res) => {
      ...
      sessionStorage.setItem("preferred_language", res.data["data"].preferred_language);
